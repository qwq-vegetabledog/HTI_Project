...
from train_yujia import init_model
...
def load_checkpoint_and_model(checkpoint_path, _device='cpu'):
    ...
    lang_model = checkpoint.get('lang_model', None)
    pose_dim = checkpoint.get('pose_dim', args.pose_dim if hasattr(args, 'pose_dim') else 27)
